...
train_dataloader = dict(
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='Coco2017_SWL/SWL_rgb31/SWL_rgb31_coco_trainval.json',
...
val_dataloader = dict(
    dataset=dict(
        metainfo=metainfo,
        data_root=data_root,
        ann_file='Coco2017_SWL/SWL_rgb31/SWL_rgb31_coco_test.json',
        data_prefix=dict(img='Data_Fiona_SL/')))

test_dataloader = val_dataloader

val_evaluator = dict(ann_file=data_root + 'Coco2017_SWL/SWL_rgb31/SWL_rgb31_coco_test.json')
