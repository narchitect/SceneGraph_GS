...
# --------------------------- testing ---------------------------#
class_name = (
    "wall", "ceiling", "light", "speaker", "door", "smoke alarm",
    "floor", "trash bin", "elevator button", "escape sign", "board",
    "fire extinguisher", "door sign", "light switch", "emergency switch button",
    "elevator", "handrail", "show window", "pipes", "staircase", "window",
    "radiator", "socket"
)
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=metainfo,
        data_root='../Ddata/SWL/',
        ann_file='annotations/SWL/SWL_coco2017.json',
        data_prefix=dict(img='images/'),
...
val_evaluator = dict(
    ann_file='../Data/SWL/annotations/SWL/SWL_coco2017.json'
)
