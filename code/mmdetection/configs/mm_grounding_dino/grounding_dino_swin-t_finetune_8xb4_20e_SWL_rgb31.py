...
metainfo = dict(classes=class_name, palette = [
    ...
    (0, 100, 0),     # radiator
    (47, 79, 79),    # stecker
    (66, 11, 230),   # chair (extension)
    (13, 20, 100),   # monitor
    (255, 0, 255),   # whiteboard
    (123, 0, 11)     # table
])
...
train_dataloader = dict(
    dataset=dict(
        ...
        ann_file='annotations/rgb31/SWL_rgb31_trainval.json',
...
val_dataloader = dict(
    dataset=dict(
        metainfo=metainfo,
        data_root=data_root,
        ann_file='annotations/rgb31/SWL_rgb31_test.json',
        data_prefix=dict(img='images/')))

test_dataloader = val_dataloader

val_evaluator = dict(ann_file=data_root + 'annotations/rgb31/SWL_rgb31_test.json')
